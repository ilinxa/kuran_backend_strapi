...
export interface ApiKuranKuran extends Struct.SingleTypeSchema {
  collectionName: 'kurans';
  info: {
    displayName: 'kuran';
    pluralName: 'kurans';
    singularName: 'kuran';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::kuran.kuran'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    surehs: Schema.Attribute.Component<'layout.surahe', true> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSurelerSureler extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['Mekki', 'Medeni']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Mekki'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::kuran.kuran': ApiKuranKuran;
      'api::sureler.sureler': ApiSurelerSureler;
